# There is a discrepancy between how iTerm2 and Lion's Terminal draw colours
# (see attached screenshots). The iTerm2 colours are much darker making text
# harder to read.
#
# The following settings only corrects the colors used in Vim color theme
# "gruvbox." https://github.com/morhetz/gruvbox
#
# see also: https://code.google.com/p/iterm2/issues/detail?id=1507
